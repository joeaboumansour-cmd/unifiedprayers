...
`piano-loop.mp3` is a 19-second phrase that loops seamlessly. The ambience fades
it in for a couple of passes, then rests for a minute or two — so it arrives as
music that comes and goes, not as a note on a timer.
